...
def main():
    ...
    user_preferences = {
        ...
        "propertyType": [
            "Single Family",
            "Apartment",
        ],  # Optional, e.g., "Single Family", "Condo", "Townhouse
    }
    ...
    similar_properties = get_similar_properties(
        user_id, all_properties, user_preferences, svd_model
    )
    ...
    for property in similar_properties:
        print(
            ...
            property["floorSizeValue"],
            property["mostRecentPriceAmount"],
